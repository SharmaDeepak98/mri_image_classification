...
List<Tumor> tumors = [
  Tumor(
      ...
      imageUrl: 'images/Neurocytoma.jpg'),
  Tumor(
      ...
      imageUrl: 'images/Tuberculoma.png'),
  Tumor(
      ...
      imageUrl: 'images/Schwannoma.jpg'),
  Tumor(
      tumorName: 'Papilloma',
      tumorDes:
      ...
      imageUrl: 'images/Papilloma.jpeg'),
  Tumor(
      ...
      imageUrl: 'images/Meningioma.jpg'),
  Tumor(
      ...
      imageUrl: 'images/Oligodendroglioma.jpg'),
  Tumor(
      ...
      imageUrl: 'images/Meduloblastoma.jpg'),
  Tumor(
      tumorName: 'Granuloma',
      tumorDes:
      ...
      imageUrl: 'images/Granuloma.jfif'),
  Tumor(
      ...
      imageUrl: 'images/Glioblastoma.jpg'),
  Tumor(
      tumorName: 'Germinoma',
      tumorDes:
      ...
      imageUrl: 'images/Germinoma.jpg'),
  Tumor(
      tumorName: 'Ependimoma',
      tumorDes:
      ...
      imageUrl: 'images/Ependimoma.jpg'),
  Tumor(
      tumorName: 'Ganglioglioma',
      tumorDes:
      ...
      imageUrl: 'images/Ganglioglioma.jfif'),
  Tumor(
      tumorName: 'Carcinoma',
      tumorDes:
  ...
  Tumor(
      ...
      imageUrl: 'images/Astrocitoma.jfif'),
];
